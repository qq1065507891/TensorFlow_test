...
def read_and_decode(filename_queue, img_height=IMG_HEIGHT, img_width=IMG_WIDTH, chars_num=CHAR_NUM):
    ...
    label.set_shape([chars_num])
    reshape_label = tf.reshape(label, [chars_num])
